...
- Source of truth: `src/generate_synthetic_data.py`, `src/pipeline.py`, `app.py`, `analysis/hospital_flow_regression.R`, and `tests/test_pipeline.py`.
...
- Keep the R companion labelled as educational and runtime-unverified; the hosted application executes Python, not R.
